      ...
      <AnimatePresence mode="wait">
        ...
        {state === "empty" && !uploadError && (
          ...
          >
            ...
            <p className="mb-6 max-w-[280px]" style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "14px", color: "var(--muted)", lineHeight: 1.5 }}>
            ...
            <div className="flex flex-col w-full gap-3">
              ...
              {fileValidationError && (
                <p style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "13px", color: "#C41101", textAlign: "center" }}>
                  {fileValidationError}
                </p>
              )}
              <button
        ...
        {state === "uploading" && (
          <motion.div key="uploading" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="app-card flex flex-col items-center text-center !p-10">
            ...
            <p className="mb-6" style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "13px", color: "var(--muted)" }}>
        ...
        {state === "error" && uploadError && (
          <motion.div key="error" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="app-card !p-0 overflow-hidden">
            <div style={{ background: "#FEF2F2", border: "1px solid #FECACA", borderRadius: "14px", padding: "20px", textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "13px", color: "#7F1D1D", lineHeight: 1.5, marginBottom: uploadError.hint ? "10px" : "16px" }}>
                {uploadError.message}
              </div>
              {uploadError.hint && (
                <div style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "12px", color: "#6E665C", background: "rgba(0,0,0,.04)", borderRadius: "8px", padding: "10px 12px", marginBottom: "16px", lineHeight: 1.4 }}>
                  {uploadError.hint}
                </div>
              )}
              <button
          ...
          <motion.div key="success" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="app-card !p-6 flex flex-col gap-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "14px", color: "var(--text)", lineHeight: 1.5, marginTop: "2px" }}>{result.summary}</p>
              </div>
            </div>
                  ...
                  {result.metrics.map((m, i) => {
                    ...
                    return (
                      <div key={i} className="rounded-lg p-3" style={{ backgroundColor: "var(--card2)" }}>
                        ...
                        {m.note && <p style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "11px", color: "var(--muted)", marginTop: "2px" }}>{m.note}</p>}
                      </div>
                    );
                  })}
                </div>
            ...
            {result.doctor_notes && (
              <div className="rounded-lg p-4" style={{ backgroundColor: "var(--card2)", borderLeft: "3px solid var(--red)" }}>
                ...
                <p style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "13px", color: "var(--text-soft)", lineHeight: 1.5 }}>{result.doctor_notes}</p>
              </div>
            )}
                ...
                <div className="flex flex-col gap-1.5">
                  {result.recommendations.map((r, i) => (
                    <div key={i} className="flex items-start gap-2">
                      ...
                      <p style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "13px", color: "var(--text-soft)", lineHeight: 1.4 }}>{r}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="flex items-center justify-between pt-3" style={{ borderTop: "1px solid var(--border-subtle)" }}>
              <p style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "11px", color: "var(--muted)" }}>Reviewed by AI · {result.reviewed_at}</p>
              <button
                onClick={() => fileInputRef.current?.click()}
                className="flex items-center gap-1 transition-opacity hover:opacity-70"
                style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "12px", color: "var(--muted)" }}
            ...
            >
              ...
              {nameMismatch && detectedName && (
                <div style={{ background: "#FEF3C7", border: "1px solid #FCD34D", borderRadius: "12px", padding: "14px 16px", marginBottom: "16px", display: "flex", gap: "10px", alignItems: "flex-start" }}>
                  ...
                  <div>
                    <div style={{ fontFamily: "Inter, sans-serif", fontSize: "13px", letterSpacing: "1px", color: "#92400E", marginBottom: "4px" }}>NAMA TIDAK SESUAI</div>
                    <div style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: "13px", color: "#78350F", lineHeight: 1.4 }}>
              ...
              <div style={{ background: "#fff", borderRadius: 10, padding: "14px 16px", marginBottom: 20, display: "flex", flexDirection: "column", gap: 6 }}>
                {detectedName && (
                  <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                    ...
                    <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: 13, color: "#0A0908" }}>{detectedName}</span>
                  </div>
                )}
                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                  ...
                  <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: 13, color: "#0A0908" }}>Medical Checkup / Lab Result</span>
                </div>
                {pendingResult?.grade && (
                  <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 24 }}>
                {[
                  ...
                  <label key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12, cursor: "pointer" }}>
                    ...
                    <span
                      onClick={() => setChecks((prev) => prev.map((v, idx) => (idx === i ? !v : v)))}
                      style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: 13, color: "#0A0908", lineHeight: 1.5 }}
                    >
                      {label}
                    </span>
                  </label>
              ...
              <button
                ...
                style={{ display: "block", width: "100%", marginTop: 12, background: "none", border: "none", cursor: "pointer", fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: 13, color: "#9E9891", textAlign: "center" }}
              >
                Batal
              </button>
            </motion.div>
