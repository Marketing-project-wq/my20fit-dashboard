...
export default function AuthCallback() {
  ...
  if (error) {
    return (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100vh", background: "#F4F2EE", fontFamily: "Inter, sans-serif" }}>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100vh", background: "#F4F2EE", gap: 16 }}>
      ...
      <div style={{ fontFamily: "Inter, sans-serif", fontSize: 16, letterSpacing: "2px", color: "#0A0908" }}>
        MENGHUBUNGKAN AKUN…
      </div>
