      ...
      <main className="flex-1 w-full lg:pl-[220px]">
        ...
        <div style={{ maxWidth: 680, margin: "0 auto", padding: "20px 16px 100px" }}>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 400, fontStyle: "italic", fontSize: 13, color: "rgba(255,255,255,.55)", marginTop: 2 }}>
                  {mockUser.email}
                </div>
              </div>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "center" }}>
                ...
                <span style={{
                  ...
                  fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 400, fontStyle: "italic", fontSize: 10,
                  padding: "4px 12px", borderRadius: 99,
                }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 10, marginBottom: 16 }}>
            {stats.map(stat => (
              <div key={stat.label} style={{
                ...
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 22, fontWeight: 400, color: "var(--text)", lineHeight: 1 }}>
                  {stat.value}
                  {stat.unit && (
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 400, fontStyle: "italic", fontSize: 12, color: "var(--muted)", marginLeft: 2 }}>
                      {stat.unit}
                    </span>
                  )}
                </div>
          ...
          <div style={{ background: "var(--card)", borderRadius: 14, padding: "0 20px", boxShadow: "var(--shadow)", marginBottom: 16 }}>
            {infoRows.map((row, i) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 400, fontStyle: "italic", fontSize: 11, color: "var(--muted)", marginBottom: 2 }}>
                    {row.label}
                  </div>
                  <div style={{
                    fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 400, fontSize: 15,
          ...
          {mockUser.isPlusMember ? (
            <div style={{ background: "linear-gradient(135deg, #1A1A0F, #0A0A05)", borderRadius: 14, padding: "20px", marginBottom: 16 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                ...
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 24, fontWeight: 400, color: "#D4A800" }}>✓</div>
              </div>
          ...
          <div style={{ textAlign: "center", padding: "20px 0 8px", marginBottom: 16 }}>
            ...
            <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 400, fontStyle: "italic", fontSize: 11, color: "var(--muted)", marginTop: 4 }}>
